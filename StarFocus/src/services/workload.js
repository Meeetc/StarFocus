...
export function calculateWorkloadScore(tasks) {
    ...
    // Normalize to 0–100 (assume max reasonable load is ~5 high-priority tasks)
    const maxExpectedLoad = 5;
    const score = Math.min(Math.round((rawScore / maxExpectedLoad) * 100), 100);
